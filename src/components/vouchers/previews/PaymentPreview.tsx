...
export const PaymentPreview: React.FC<PaymentPreviewProps> = ({ voucher, companySettings }) => {
    ...
    <div className="p-12 bg-white text-black font-serif text-xs leading-relaxed border border-slate-200 shadow-inner max-w-[800px] mx-auto print:p-0 print:border-0 print:shadow-none print:max-w-none">
      ...
      <div className="flex justify-between items-start mb-10">
        ...
        <div className="w-1/3 text-center">
          <h2 className="text-2xl font-bold uppercase tracking-wider">PHIẾU CHI</h2>
      ...
      <div className="space-y-3 mb-10">
        <p><span className="font-bold">Họ và tên người nhận tiền:</span> {metadata?.receiverName || '................................................................'}</p>
        <p><span className="font-bold">Địa chỉ:</span> {metadata?.receiverAddress || '................................................................'}</p>
        <p><span className="font-bold">Lý do chi:</span> {description || '................................................................'}</p>
      ...
      <VoucherSignatures
        signatures={[
          ...
          { role: 'Người nhận tiền', subtext: '(Ký, họ tên)' },
